...
void MainWindow::switchPage(){
    ...
    /*int i = 0;
    ui->stackedWidget->widget(i);*///将对应页面显示出来
}
...
void MainWindow::ShowPie()
{
       ...
       //会重启一段
        ...
        //// ////把QStringList转成QString显示在标签上开始
        //QString *str=new QString;
       // *str=strlist->join("\n");
        //ui->lblDisplayData->setText(*str);//显示标签内容
        //delete str;
       // delete strlist;
        //// ////把QStringList转成QString显示在标签上结束

        //// ////画表开始
        QChart *chart = new QChart();//创建chart//别删除这个，不然看不到
        chart->addSeries(pies);//把之前准备好的series放到表里
        //chart->resize();
        //chart->setTitle("Proportion");//设置chart的标题
        //chart->legend()->hide();//这个是图示，什么颜色代表什么kind，hide了就看不到了
...
//    ui->test->setMenu(out);
    ...
    ui->TitleIcon->setPixmap(titlen);
    ui->TitleIcon->resize(70,70);
    ui->TitleIcon->move(40,10);
